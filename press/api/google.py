...
def invalid_login():
	...
	return "Invalid state parameter. The session timed out. Please try again or contact  ERPNU Cloud support at https://frappecloud.com/support"
