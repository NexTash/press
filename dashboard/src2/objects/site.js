		...
		tabs: [
			...
			},
			{
				...
				list: {
					...
					banner({ documentResource: site }) {
						const bannerTitle =
							'Your site is currently on a shared bench group. Upgrade plan for offsite backups and <a href="https://nextash.cloud/shared-hosting#benches" class="underline" target="_blank">more</a>.';
			...
			},
			{
				...
				list: {
					...
					banner({ documentResource: site }) {
						const bannerTitle =
							'Your site is currently on a shared bench group. Upgrade to a private bench group to configure auto updates and <a href="https://nextash.cloud/shared-hosting#benches" class="underline" target="_blank">more</a>.';
