<template>
	<Card
		title="NexTash Partner"
		subtitle="NexTash Partner associated with your account"
		...
		<div>
			...
			<div class="py-4">
				<h3 class="text-base text-gray-700" v-if="$account.parent_team">
					Only parent team can link with NexTash Partner.
				</h3>
				<h3
					class="text-base text-gray-700"
					v-if="!$account.partner_email && !$account.parent_team"
				>
					Have a NexTash Partner Referral Code? Click on
