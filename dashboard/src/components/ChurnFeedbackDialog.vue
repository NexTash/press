	...
	>
		<template v-slot:body-content>
			...
			<FormControl
				...
				type="textarea"
				variant="outline"
				placeholder="I am leaving NexTash Cloud because..."
				size="md"
				v-model="note"
			/>
	...
	computed: {
		options() {
			return [
				...
				'Moved site to another NexTash Cloud account',
				'I did not like the NexTash Cloud experience',
				'NexTash Cloud is too expensive for me',
				'Payment issues',
				'Features were missing',
				'My reason is not listed here',
			];
